...
@AllArgsConstructor
@NoArgsConstructor
public class AmadeusFlightBookingRepository implements FlightBookingRepository{

    public static final Logger LOGGER = Logger.getLogger(AmadeusFlightBookingRepository.class.getName());
