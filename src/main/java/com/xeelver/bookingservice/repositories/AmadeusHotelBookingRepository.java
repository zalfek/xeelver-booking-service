...
@AllArgsConstructor
@NoArgsConstructor
public class AmadeusHotelBookingRepository implements HotelBookingRepository{
    ...
    public static final Logger LOGGER = Logger.getLogger(AmadeusHotelBookingRepository.class.getName());
