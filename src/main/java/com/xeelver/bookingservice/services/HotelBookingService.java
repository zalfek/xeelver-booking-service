...
import com.xeelver.bookingservice.repositories.HotelBookingRepository;
import com.xeelver.bookingservice.repositories.HotelSearchRepository;
...
public class HotelBookingService {
    ...
    public String createHotelBooking(Map<String, String> request){
        ...
        JsonObject availability = hotelSearchRepository.getHotelPrice(request.get("hotelId"));
        if (!availability.get("available").getAsBoolean()){
            ...
            return this.getData(hotelBookingRepository.bookHotel(availability));
        }
    }
